...
static cl::opt<bool>
    CanonPadZero("amdgpu-late-codegenprepare-canon-pad-zero",
                 cl::desc("Canonicalize poison/zero shuffle operands to "
                          "zeroinitializer in AMDGPULateCodeGenPrepare"),
                 cl::ReallyHidden, cl::init(true));
...
static bool isNullOrPoisonVector(Constant *C) {
